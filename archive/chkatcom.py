...
class Checking(threading.Thread):
			...
			if int(sr) > 1:
				...
				if success in canit:
					...
					for aurl in archiveurls:
						...
						# self.avail.writerow([rs])
						self.avail.writerow([domain,sr,len(archiveurls)])
	...
	def geturls(self,domain):
		times = ['20080201000000','20080401000000','20080601000000','20080801000000','20081001000000','20081201000000','20090201000000','20090401000000','20090601000000','20090801000000','20091001000000','20091201000000','20100201000000','20100401000000','20100601000000','20100801000000','20101001000000','20101201000000','20110201000000','20110401000000','20110601000000','20110801000000','20111001000000','20111201000000','20120201000000','20120401000000','20120601000000','20120801000000','20121001000000','20121201000000','20130201000000','20130401000000','20130601000000','20130801000000','20131001000000','20131201000000','20140201000000','20140401000000','20140601000000','20140801000000','20141001000000','20141201000000','20150201000000','20150401000000','20150601000000','20150801000000','20151001000000','20151201000000','20160201000000','20160401000000','20160601000000']
...
def main():
	...
	url = 'http://domain.webmasterhome.cn/afterTomorrowDel_domain.asp'
	try:
		html = urllib2.urlopen(url).read().strip()
	except Exception:
		html =  ''

	html=html.split('</strong><br>')[1]
	html = html.split('</pre>')[0]
	domains = html.split('\n')

	# domain_file = open('yesterday.txt')
	#domain.txt 为域名文件，每行一个域名，不要有www或者是http这些，只留域名的主体和后缀，如：baidu.com
	avail = open('2yesterday_com_'+tomorrow+'.csv','ab+') # avail.csv为导出的结果文件，生成在当前脚本文件所在目录
	# fields = ['----------------------------------------'+today+'----------------------------------------']
	fields = ["Domain", "Sogou Rank","Count",today]
	w = csv.writer(avail)
	w.writerow(fields)

	queue = Queue.Queue()
	for domain in domains:
		if  'gov.cn' not in domain:
			print domain
			domain = domain.strip()
			queue.put(domain)
